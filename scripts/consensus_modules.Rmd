...
main_path <- ('/Users/asm/Creighton/celegan/Modules/_consensus')
other_path <- ('/Users/asm/Creighton/celegan/Modules')
...
write.xlsx(hub_list[[i]], file=file.path(tissue_dir, "hub_genes.xlsx"), sheetName=names(hub_list[i]), row.names=FALSE, append=TRUE, col.names= FALSE)
}
...
age.cor.heatmap <- function (tissue_name) {
  ...
  pheatmap(day_cor,scale = "none",cluster_rows=T,cluster_col=F,color = heat.colors,border_color=NA)
  dev.off()
